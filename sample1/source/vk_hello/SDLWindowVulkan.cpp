...
SDLWindowVulkan::_CreateGraphicsPipeline()
{
    ...
    core::Scoped   scopedFragment([&]() { return gfx::createShaderModule(_device, fragShaderCode); },
        [&]() {
    ...
    core::Scoped   scopedVertex([&]() { vertexShaderModule = gfx::createShaderModule(_device, vertShaderCode); },
        [&]() {
